...
lista.insert(posição,item) insere na posição o item, os outros itens tem suas posições reajustadas 

2 - APAGAR ELEMENTOS

2.1 del lista[i] - remove o item de indice i da lista

2.2 lista.pop(i) - tem como passar como parâmetro o índice do elemento que se quer eliminar se não passar nenhum parâmetro ele elimina o último elemento
